...
function styles() {
  return (
    ...
    // src('app/scss/style.scss') БЫЛО
    src(['node_modules/animate.css/animate.css', 'app/scss/style.scss'])
      ...
      .pipe(
        autoprefixer({
          ...
          // grid: true,
          grid: 'autoplace',//включает автоматическое размещение элементов сетки
        }),
      )
      .pipe(dest('app/css'))
